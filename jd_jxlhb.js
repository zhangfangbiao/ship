...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  let res = []
  res = await getAuthorShareCode('https://raw.githubusercontent.com/zhangfangbiao/sharecode/main/jd_jxlhb.json')
  if (!res) {
    res = await getAuthorShareCode('https://gitee.com/zhangfangbiao/sharecode/raw/main/jd_jxlhb.json')
    }
  if (res?.activeId) $.activeId = res.activeId;
